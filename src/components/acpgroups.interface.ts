...
export interface IAcpGroups {
  searchAcpGroups: Function;
  getAcpGroupsByAcpId: Function;
}

/**
 * this interface file give the flexibility to add other relational interfaces that can be used in adapter pattern.
 * Using adapter pattern makes your code scalable and provide more absttraction without the need of chaning your code base.
 *  See Example below
 */
